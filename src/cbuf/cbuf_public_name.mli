...
val ident_of_ml_prim : 'a Ctypes_primitive_types.ml_prim -> Cbuf_path.path
(* The type that should appear in the extern signature *)

val constructor_ident_of_prim : 'a Ctypes_primitive_types.prim -> Cbuf_path.path
(* The path to a value that represents the primitive type *)

val constructor_cident_of_prim :
  ?module_name:string -> 'a Ctypes_primitive_types.prim -> Cbuf_path.path
